...
namespace Infra.Shared.Helpers
{
    public static class MimeTypesHelper
    {
        private static readonly Lazy<IDictionary<string, string>> _mappings =
            new Lazy<IDictionary<string, string>>(new Func<IDictionary<string, string>>(BuildMappings));
        ...
        private static IDictionary<string, string> BuildMappings()
        {
            ...
            foreach (KeyValuePair<string, string> keyValuePair in source.ToList<KeyValuePair<string, string>>())
            {
                if (!source.ContainsKey(keyValuePair.Value))
                    source.Add(keyValuePair.Value, keyValuePair.Key);
            }

            return (IDictionary<string, string>) source;
        }
        ...
        public static string GetMimeType(string extension)
        {
            ...
            if (!extension.StartsWith("."))
                extension = "." + extension;
            string str;
            if (!_mappings.Value.TryGetValue(extension, out str))
        ...
        public static string GetExtension(this string mimeType, bool throwErrorIfNotFound)
        {
            ...
            string str;
            if (_mappings.Value.TryGetValue(mimeType, out str))
                return str;
